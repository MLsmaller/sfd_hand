...
_C = EasyDict()  #创建了一个dict{}  _C
cfg = _C
# data augument config   数据增加的一些设置
_C.MAX_STEPS= 100000
_C.expand_prob = 0.5   #{expand_prob:0.5}
...
# hand config
_C.HAND = EasyDict()   #想要hand有key和value时,首先_C.HAND=EasyDict()创建为一个字典
_C.HAND.TRAIN_FILE = '/home/lj/projects/detection/detectHand/sfd_hand/json_file/train.txt'
_C.HAND.VAL_FILE = '/home/lj/projects/detection/detectHand/sfd_hand/json_file/val.txt'
_C.HAND.DIR = '/home/data/lj/egohands/'
_C.HAND.OVERLAP_THRESH=0.35
_C.HAND.NUM_CLASSES=3
